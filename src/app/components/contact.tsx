    ...
    return <>
        ...
        <div className=" flex justify-around items-center flex-col sm:flex-row gap-10">
            ...
            <div className="p-2 flex flex-col">
                <a href="#about" className="text-sm text-[#0A192F] dark:text-[#E6F1FF]">Sobre mí</a>
                <a href="#skills" className="text-sm text-[#0A192F] dark:text-[#E6F1FF]">Habilidades</a>
                <a href="#projects" className="text-sm text-[#0A192F] dark:text-[#E6F1FF]">Proyectos</a>
                <a href="#experience" className="text-sm text-[#0A192F] dark:text-[#E6F1FF]">Experiencia</a>
                <a href="#contact" className="text-sm text-[#0A192F] dark:text-[#E6F1FF]">Contacto</a>
            </div>
        ...
        <div className="p-1">
            ...
            <p className="text-center text-[#0A192F] dark:text-[#E6F1FF] text-[0.6rem] leading-relaxed">
